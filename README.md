...
Разрешается перемещаться только на 1 клетку в любую из 4 сторон:вверх/вниз,вправо/влево. Перемещение по диагонали запрещено,т.к. я посчитал что это было бы не честно, ведь перемещение по диагонали это шаг сразу и по x и по y, а это уже читерство,поэтому <i>BANNED</i>!
