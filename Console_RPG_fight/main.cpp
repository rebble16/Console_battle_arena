//РЕАЛИЗОВАТЬ ИГРУ БОЙ 1 НА 1 ПЕРСОНАЖИ:ВОИН,ЛУЧНИК,МАГ,ГОБЛИН , чтобы на карте отображалось их перемещение и если МАГ и лучник сближаются с противником они отбегают и только потом могут наносить урон,гоблин и воин наоборот
#include "Warrior.h"
#include "Orc.h"
#include "Magician.h"
#include<fstream>
